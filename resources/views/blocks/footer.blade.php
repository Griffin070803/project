<div class="footer">
    <div class="container">
        <div class="w3_agile_footer_grids">
            ...
            <div class="col-md-4 w3_agile_footer_grid">
                <h3 class="white-w3ls">Marine Creatures</h3>
                ...
                <div class="w3_agileits_footer_grid_left">
                    <a href="#" data-toggle="modal" data-target="#myModal">
                        <img src="{{ asset('assets/images/f5.jpg') }}" alt=" " class="img-responsive" />
                    </a>
                </div>
                <div class="w3_agileits_footer_grid_left">
                    <a href="#" data-toggle="modal" data-target="#myModal">
                        <img src="{{ asset('assets/images/f6.jpg') }}" alt=" " class="img-responsive" />
                    </a>
                </div>
        ...
        <div class="w3ls_address_mail_footer_grids">
            <div class="col-md-4 w3ls_footer_grid_left">
                ...
                <p>300 Ocean Ave N, Point Pleasant Beach, <span>Singapore</span></p>
            </div>
            <div class="col-md-4 w3ls_footer_grid_left">
                <div class="wthree_footer_grid_left">
